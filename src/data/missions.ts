...
export const MISSIONS: MissionDef[] = [
  ...
  },
  {
    ...
    description: "Learn to inspect files before you download them — Robo Buddy runs the Cyber Download Inspection Center!",
    icon: Shield,
    color: "text-cyan-500",
    ...
    levelMiniGames: [
      ["quiz", "scenario"],
      ["sort-game", "quiz", "memory"],
      ["scenario", "boss-battle"],
    ],
    badgeId: "download-detective",
    badgeName: "Download Detective",
    badgeIcon: "📥",
    questionsByTier: {
      junior: [
        { question: "A pop-up says 'FREE game download! Click here!' What do you do?", miniGameType: "quiz", options: ["Click it — free games are awesome!", "Close it and tell a grown-up"], correct: 1, explanation: "Free game pop-ups are almost always traps. Close them and never click!" },
        { question: "Where is the safest place to download apps?", miniGameType: "quiz", options: ["Any website", "Official app stores like App Store or Google Play"], correct: 1, explanation: "Official stores check apps for safety. Random websites do not!" },
        { question: "Sort — safe or unsafe download?", miniGameType: "sort-game", options: ["App Store download", "Random website .exe file", "Google Play download"], correct: 1, explanation: "App stores are safe. Random .exe files from websites are dangerous!" },
        { question: "A website says 'Your device has a virus! Download this to fix it!'", miniGameType: "scenario", options: ["Download it quickly!", "Close the page — it's a trick"], correct: 1, explanation: "This is a fake virus warning scam. Real antivirus software doesn't pop up on websites!" },
        { question: "Before downloading anything, you should:", miniGameType: "quiz", options: ["Just click download", "Ask a trusted adult first"], correct: 1, explanation: "Always check with a trusted adult before downloading anything!" },
      ],
      defender: [
        { question: "A file is named 'game_setup.exe.pdf'. What is the real file type?", miniGameType: "quiz", options: [".pdf — safe document", ".exe — a program that can run code"], correct: 1, explanation: "The real extension is the last one. This is an .exe disguised as a PDF — a common malware trick!" },
        { question: "You want to download free photo editing software. The safest approach is:", miniGameType: "quiz", options: ["Search Google and click the first result", "Go directly to the official developer's website"], correct: 1, explanation: "Fake download sites mimic official ones. Always go directly to the developer's official site!" },
        { question: "Sort — red flags in a download page:", miniGameType: "sort-game", options: ["Multiple 'Download' buttons in different sizes", "Countdown timer pressuring you to download", "Clear file size and version number shown", "Requests to disable your antivirus"], correct: 2, explanation: "Multiple buttons, timers, and requests to disable antivirus are all red flags. Clear file info is a good sign!" },
        { question: "A friend sends you a zip file over Discord. Before opening it:", miniGameType: "scenario", options: ["Open it — you trust your friend", "Scan it with antivirus — friends' accounts can be hacked"], correct: 1, explanation: "Friends' accounts can be hacked. Always scan files from anyone before opening, even trusted people!" },
        { question: "A download requires you to turn off your antivirus first. You should:", miniGameType: "quiz", options: ["Turn it off — the download probably needs it", "Never download anything that requires disabling antivirus"], correct: 1, explanation: "Legitimate software never needs you to disable your antivirus. This is a malware red flag!" },
      ],
      guardian: [
        { question: "What does checking a file's SHA-256 hash verify?", miniGameType: "quiz", options: ["The file's creation date", "The file hasn't been tampered with since the developer released it", "The file is virus-free"], correct: 1, explanation: "Hash verification confirms file integrity — that the file is exactly what the developer released, not a modified malicious version!" },
        { question: "A download from a trusted site triggers your browser's 'dangerous file' warning. You should:", miniGameType: "scenario", options: ["Proceed anyway — the site is trusted", "Investigate the warning — even trusted sites can be compromised"], correct: 1, explanation: "Browser warnings exist for a reason. Trusted sites can be hacked. Investigate before proceeding!" },
        { question: "Sort by safety level for software downloads:", miniGameType: "sort-game", options: ["Official developer site with verified HTTPS", "Well-known aggregator like ninite.com", "Random torrent site"], correct: 0, explanation: "Official HTTPS developer site is safest. Known aggregators are decent. Torrents are high risk!" },
        { question: "What is a 'supply chain attack' in the context of downloads?", miniGameType: "quiz", options: ["Downloading too many files at once", "Malware injected into legitimate software during development or distribution", "A phishing email with a download link"], correct: 1, explanation: "Supply chain attacks compromise legitimate software at the source — even official downloads can be affected in rare cases!" },
        { question: "A .dmg file on Mac is:", miniGameType: "quiz", options: ["Always safe — Macs don't get viruses", "A disk image installer — can still contain malware, only install from trusted sources"], correct: 1, explanation: "Macs can get malware too! .dmg files are installers and should only be downloaded from official, trusted sources." },
      ],
    },
  },
  {
    ...
    description: "Learn how to stay safe from strangers online and handle cyberbullying like a hero! Robo Buddy has your back!",
    icon: Shield,
    color: "text-cyan-500",
    bgColor: "bg-cyan-500/10",
    guide: { name: "Robo Buddy", image: robotGuide },
    ...
    badgeName: "Stranger Shield",
    badgeIcon: "🛡️",
    questionsByTier: {
      junior: [
        { question: "Someone online says 'I'm your biggest fan, tell me where you live!' What do you do?", miniGameType: "quiz", options: ["Tell them — they're a fan!", "Never share your address. Tell a grown-up!"], correct: 1, explanation: "Real fans don't need your address. Never tell strangers where you live!" },
        { question: "A stranger online says 'Don't tell your parents about our chats.' Is that OK?", miniGameType: "scenario", options: ["OK, it's our secret", "No! Secrets from parents = danger sign"], correct: 1, explanation: "Anyone asking you to keep secrets from your parents is a big warning sign!" },
        { question: "Sort these messages — safe or unsafe?", miniGameType: "sort-game", options: ["You're great at that game!", "Meet me after school, don't tell anyone", "Cool drawing!"], correct: 1, explanation: "'Meet me after school' from an online stranger is dangerous. Always tell a trusted adult!" },
        { question: "Someone is sending you mean messages online. You should:", miniGameType: "quiz", options: ["Send mean messages back", "Block, save the evidence, tell a grown-up"], correct: 1, explanation: "Block and report — then tell a trusted adult. Never reply to bullies!" },
        { question: "An online 'friend' you've never met asks for your photo. You should:", miniGameType: "quiz", options: ["Send it, they seem nice", "Never send photos to people you don't know in real life"], correct: 1, explanation: "Never send photos to someone you've only met online. Tell a trusted adult if asked!" },
      ],
      defender: [
        { question: "Someone online claims to be 12 years old but asks very adult questions. This could mean:", miniGameType: "quiz", options: ["They're just curious", "They might be lying about their age — trust your instincts"], correct: 1, explanation: "Online groomers often pretend to be kids. If something feels off, it is!" },
        { question: "A gamer you met online is friendly for weeks, then asks to move the chat to a private app. This is:", miniGameType: "scenario", options: ["Normal — they want a better app", "A red flag — grooming often starts by moving to private platforms"], correct: 1, explanation: "Moving conversations away from monitored platforms is a classic grooming tactic!" },
        { question: "Sort — online stranger warning signs:", miniGameType: "sort-game", options: ["Asks personal questions early", "Tries to move chat to private app", "Asks you to keep secrets", "Comments on your game skills"], correct: 0, explanation: "The first three are grooming red flags. Complimenting your game skills alone is usually fine." },
        { question: "A classmate is spreading rumours about you online. This is called:", miniGameType: "quiz", options: ["Just a joke", "Cyberbullying — and it's not OK"], correct: 1, explanation: "Spreading rumours online is cyberbullying. Screenshot the evidence and tell a trusted adult!" },
        { question: "You see your friend being bullied in a group chat. You should:", miniGameType: "quiz", options: ["Ignore it — not your problem", "Don't join in, support your friend, report it"], correct: 1, explanation: "Standing up for a friend (even privately) can make a huge difference. Report the bullying!" },
      ],
      guardian: [
        { question: "What is 'catfishing'?", miniGameType: "quiz", options: ["Fishing online for free games", "Pretending to be someone else online to deceive people", "A type of phishing email"], correct: 1, explanation: "Catfishing = creating a fake online identity to trick or manipulate someone." },
        { question: "An online friend sends you an edited video that makes you look bad, threatening to share it unless you do what they say. This is:", miniGameType: "scenario", options: ["Negotiable — maybe do what they say", "Sextortion/blackmail — report it immediately, don't comply"], correct: 1, explanation: "This is blackmail/coercion. Complying makes it worse. Tell a trusted adult and report it immediately!" },
        { question: "CSAM (child sexual abuse material) online should be:", miniGameType: "quiz", options: ["Shared to warn others", "Reported to the National Center for Missing & Exploited Children (NCMEC) immediately"], correct: 1, explanation: "Never share it. Report via NCMEC's CyberTipline or your country's equivalent immediately." },
        { question: "Digital evidence of cyberbullying should be:", miniGameType: "sort-game", options: ["Screenshotted and saved", "Reported to the platform", "Shared with a trusted adult", "Deleted immediately"], correct: 3, explanation: "Save evidence (screenshots), report to the platform, and tell a trusted adult. Don't delete it!" },
        { question: "A stranger online claims they work for your school and needs your login details to fix an issue. This is:", miniGameType: "quiz", options: ["Probably legitimate", "Social engineering — never share credentials, verify through official channels"], correct: 1, explanation: "This is social engineering. Real school staff never ask for passwords. Verify any such request in person!" },
      ],
    },
  },
  {
...
export const ALL_BADGES = [
  ...
  { id: "stranger-shield", name: "Stranger Shield", icon: "🛡️", category: "mission" as const, description: "Complete Stranger Safety with a perfect score" },
  { id: "download-detective", name: "Download Detective", icon: "📥", category: "mission" as const, description: "Complete Safe Downloads with a perfect score" },
