...
export const CONTINENT_PROJECTIONS: Record<string, { center: [number, number]; scale: number }> = {
  "north-america": { center: [-96, 48], scale: 380 },
  europe:          { center: [15, 52],  scale: 650 },
  africa:          { center: [22, 5],   scale: 380 },
  asia:            { center: [90, 35],  scale: 320 },
  "south-america": { center: [-58, -15], scale: 400 },
  australia:       { center: [140, -28], scale: 550 },
...
export const ZONE_COORDINATES: Record<string, { id: string; lat: number; lng: number }[]> = {
  "north-america": [
    ...
    { id: "boss-keybreaker", lat: 39.5,  lng: -105.0 },
  ],
  europe: [
