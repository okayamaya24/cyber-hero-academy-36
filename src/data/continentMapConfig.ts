...
export const CONTINENT_COUNTRIES: Record<string, string[]> = {
  "north-america": [
    "840", "124", "484", "192", "332", "388", "320", "188", "558", "591", "222", "340", "214", "630",
  ],
  europe: [
    "826", "276", "250", "724", "380", "620", "528", "056", "756", "040", "752", "578", "208", "246",
    "616", "203", "300", "642", "348", "372", "804", "112", "643",
  ],
  africa: [
    "566", "818", "404", "710", "012", "504", "788", "516", "072", "800", "834", "231", "706", "288",
    "384", "180", "178", "024", "508", "450", "562", "466", "854", "120", "148", "694", "736", "716",
    "226", "266", "140", "646", "768", "204", "270", "624", "232", "262", "174",
  ],
  asia: [
    "784", "356", "410", "392", "156", "682", "364", "050", "764", "704", "458", "360", "608", "524",
    "144", "586", "760", "368", "400", "792", "398", "860", "496", "408", "116", "418", "104", "634",
    "512", "414", "048", "275", "422",
  ],
  "south-america": [
    "076", "032", "604", "152", "170", "858", "068", "600", "218", "862", "328", "740", "254",
  ],
  australia: [
...
export const CONTINENT_PROJECTIONS: Record<string, { center: [number, number]; scale: number }> = {
  "north-america": { center: [-100, 55],  scale: 420  },
...
export const ZONE_COORDINATES: Record<string, { id: string; lat: number; lng: number }[]> = {
  "north-america": [
    { id: "hq",              lat: 38.9,  lng: -77.0 },
    { id: "password-peak",   lat: 40.7,  lng: -74.0 },
    { id: "encrypt-enclave", lat: 43.7,  lng: -79.4 },
    { id: "code-canyon",     lat: 41.8,  lng: -87.6 },
    { id: "signal-summit",   lat: 39.7,  lng: -104.9 },
    { id: "arctic-archive",  lat: 49.2,  lng: -123.1 },
    { id: "pixel-port",      lat: 34.0,  lng: -118.2 },
    { id: "shadow-station",  lat: 19.4,  lng: -99.1 },
    { id: "boss-keybreaker", lat: 39.5,  lng: -106.0 },
  ],
  europe: [
