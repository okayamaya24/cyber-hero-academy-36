...
export const CONTINENTS: ContinentDef[] = [
  {
    ...
    zones: [
      ...
      { id: "password-peak", name: "Password Peak", icon: "🔑", city: "New York", lat: 40.7, lng: -74.0 },
      { id: "encrypt-enclave", name: "Encrypt Enclave", icon: "🔐", city: "Toronto", lat: 43.7, lng: -79.4 },
      { id: "boss-keybreaker", name: "Keybreaker's Vault", icon: "⚔️", city: "Rocky Mountains", lat: 39.5, lng: -105.0, isBoss: true },
    ],
  },
  {
    id: "europe",
