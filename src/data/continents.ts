...
export const CONTINENTS: ContinentDef[] = [
  {
    ...
    unlockOrder: 0,
    silhouettePath:
      "M30,15 L40,12 L55,10 L60,15 L58,25 L55,30 L50,35 L48,42 L45,48 L40,55 L35,60 L30,58 L25,50 L22,40 L20,30 L25,20 Z",
    zones: [
      {
        id: "pixel-port",
        name: "Pixel Port",
      ...
      {
        id: "boss-keybreaker",
        name: "Keybreaker's Vault",
        icon: "⚔️",
        city: "Northern Canada",
        lat: 56.0,
        lng: -95.0,
        isBoss: true,
      },
  ...
  },
  {
    ...
    zones: [
      ...
      { id: "wifi-watch", name: "WiFi Watch", icon: "📶", city: "Oslo, Norway", lat: 59.9, lng: 10.7 },
  ...
  },
  {
    ...
    zones: [
      ...
      {
        id: "boss-shadowbyte",
        name: "SHADOWBYTE's Core",
        icon: "⚔️",
        city: "Center of Antarctica",
        lat: -85.0,
        lng: 0,
        isBoss: true,
      },
