...
export default function CreateChildPage() {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast.success(`${form.name}'s hero profile is ready! 🎉`);
        ...
        <div className="mb-8 text-center">
          <div className="relative mx-auto mb-4 flex justify-center">
            ...
            <motion.img
              src={wiseOwl}
              alt="Professor Hoot"
              className="h-24 w-24 object-contain -ml-4"
              initial={{ x: 20, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
          ...
          <p className="mt-2 text-muted-foreground">
            Set up your child's hero profile to start learning
          </p>
        </div>
        ...
        >
          ...
          <div>
            <Label className="flex items-center gap-2 text-sm font-semibold">
              <Sparkles className="h-4 w-4 text-primary" /> Choose an Avatar
            </Label>
          ...
          <Button
            ...
            disabled={creating}
          >
            {creating ? "Creating Profile..." : "Create Hero Profile 🚀"}
          </Button>
