// Run this once to upload the Professor Hoot Lesson 1 video to Supabase
// Usage: node upload-lesson-hoot1.mjs
...
const VIDEO_PATH = "/Users/amayaharris/cyber-hero-academy-36/Cyber Hero Academy_ Your Personal Info_1080p_caption.mp4";
...
async function upload() {
  ...
  console.log("\n🎉 Done! Professor Hoot Lesson 1 video is live.");
}
