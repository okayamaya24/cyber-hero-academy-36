// Run this once to upload the captioned Lesson 2 video to Supabase
// Usage: node upload-lesson2.mjs
...
const VIDEO_PATH = "/Users/amayaharris/cyber-hero-academy-36/Lesson 2_1080p_caption (1).mp4";
...
async function upload() {
  ...
  console.log("\n🎉 Done! The Lesson 2 captioned video is live.");
}
