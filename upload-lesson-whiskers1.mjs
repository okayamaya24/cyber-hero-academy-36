// Run this once to upload the Detective Whiskers Lesson 1 video to Supabase
// Usage: node upload-lesson-whiskers1.mjs
...
const VIDEO_PATH = "/Users/amayaharris/cyber-hero-academy-36/Cyber Hero Academy_ What Is Phishing__1080p_caption.mp4";
...
async function upload() {
  ...
  const { data, error } = await supabase.storage
    .from("lessons")
    .upload("Lesson-Whiskers1.mp4", file, {
  ...
  console.log("\n🎉 Done! Detective Whiskers Lesson 1 video is live.");
}
