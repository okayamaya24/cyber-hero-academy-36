// Run this once to upload the Professor Hoot Lesson 2 video to Supabase
// Usage: node upload-lesson-hoot2.mjs
...
const VIDEO_PATH = "/Users/amayaharris/cyber-hero-academy-36/Chapter 3 — Privacy & Personal Information_ Smart Sharing Online_1080p_caption.mp4";
...
async function upload() {
  ...
  console.log("\n🎉 Done! Professor Hoot Lesson 2 video is live.");
}
